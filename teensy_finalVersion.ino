...
String modus = "";
//char selsong[numChars];     //array for the selected song
//const char *fileextension = ".wav\0";  //file extension for the selected song
String selsong;
        ...
        if (rc != endMarker) {
           ...
           ndx++;
            ...
            if (receivedChars[0] == '0'){
              ...
              Serial.println("entered else-cond");
              //strcat(receivedChars, fileextension);
              //strcpy(selsong, receivedChars);
...
void handleMode(int programMode, String selsong){
  switch (programMode){
    ...
    case 2:                           //playSelected    TESTED SUCESSFULLY!
      if (buttonPlay.fallingEdge()){   
        ...
        selsong += ".wav";
        Serial.println(selsong);
        char buf[selsong.length()+1];
        selsong.toCharArray(buf, sizeof(buf));
